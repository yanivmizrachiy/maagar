...
- הניווט הוא drill-down בן 4 רמות: בית (בחירת שכבה) → שכבה (כפתורי תחום: אלגברה, גיאומטריה, עבודות סיכום, מבחנים, שונות) → תחום (רשימת נושאים) → נושא (הקבצים).
- בכל רמה מוצג כפתור "חזרה" שעולה רמה אחת; רשימת קבצים מופיעה רק אחרי בחירת נושא.
